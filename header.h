...
void Sxema (const P_gas &p_g, const P_she &p_s, std::vector<double> &curr_V, std::vector<double> &curr_H, res &result, int bound, bool first, const char *name);
...
void write_for_plot (const char *name, const std::vector<double> &curr_H, const std::vector<double> &curr_V, int t, const P_she &p_s);
